package org.example.bot.domain.bot.util;
...
public class Sender {
    public static void send(Object o, Bot bot) {
        try {
            if (o instanceof SendPhoto) {
                ...
                bot.execute((SendVideo) o);
            } else if (o instanceof SendAudio) {
                bot.execute((SendAudio) o);
            }
        } catch (Exception e) {
    ...
    public static void editCaptionStyle(Long chatId, Integer messageId, String message, InlineKeyboardMarkup button, Bot bot) {
        ...
        try {
            ...
            log.error("Can't send message chat id = {} cause {} {}", chatId, e.getCause(), e.getMessage());
        }
    }

    public static void editMessageStyle(Long chatId, Integer messageId, String message, InlineKeyboardMarkup button, Bot bot) {
    ...
    public static void editMessageStyleHtml(Long chatId, Integer messageId, String message, InlineKeyboardMarkup button, Bot bot) {
        EditMessageText editMessageCaption = new EditMessageText();
        editMessageCaption.setChatId(chatId);
        editMessageCaption.setMessageId(messageId);
        editMessageCaption.setText(message);
    ...
    public static Message sendMsg(Long chatId, String message, ReplyKeyboard replyKeyboard, Bot bot, Integer replyId) {
    ...
    public static Message sendMsg(Long chatId, String message, InlineKeyboardMarkup replyKeyboard, Bot bot) {
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(chatId);
        sendMessage.setText(message);
        sendMessage.setReplyMarkup(replyKeyboard);
    ...
    public static Integer sendMsgStyle(Long chatId, String message, ReplyKeyboard replyKeyboard, Bot bot, Integer replyId) {
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(chatId);
        sendMessage.setText(message);
    ...
    public static Integer sendMsgStyle(Long chatId, String message, ReplyKeyboard replyKeyboard, Bot bot) {
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(chatId);
        sendMessage.setText(message);
        sendMessage.setParseMode("HTML");
    ...
    public static Integer sendMsgStyleHtml(Long chatId, String message, ReplyKeyboard replyKeyboard, Bot bot) {
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(chatId);
        sendMessage.setText(message);
        sendMessage.setParseMode("HTML");
